...
void updateControl(){
  // read the knob
  int knob_value = mozziAnalogRead(1023); // value is 0-1023
  ...
  int light_level= mozziAnalogRead(1023); // value is 0-1023
  ...
  fm_intensity = kMapIntensity(random(0,1023));
